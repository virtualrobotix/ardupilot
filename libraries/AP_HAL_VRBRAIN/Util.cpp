...
bool VRBRAINUtil::flash_bootloader()
{
...
bool VRBRAINUtil::toneAlarm_init()
{
...
void VRBRAINUtil::toneAlarm_set_buzzer_tone(float frequency, float volume, uint32_t duration_ms)
{
    if (_tonealarm_fd == -1) {
        return;
    }
