...
/*
  ...
  critical regions
*/
void *VRBRAINScheduler::disable_interrupts_save(void)
{
...
*/
void VRBRAINScheduler::restore_interrupts(void *state)
{
...
*/
void *VRBRAINScheduler::thread_create_trampoline(void *ctx)
{
...
/*
  create a new thread
*/
bool VRBRAINScheduler::thread_create(AP_HAL::MemberProc proc, const char *name, uint32_t stack_size, priority_base base, int8_t priority)
{
