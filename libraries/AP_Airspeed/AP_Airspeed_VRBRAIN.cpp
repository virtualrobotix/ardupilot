...
bool AP_Airspeed_VRBRAIN::get_differential_pressure(float &pressure)
{
    if (_fd == -1) {
        return false;
    }
...
bool AP_Airspeed_VRBRAIN::get_temperature(float &temperature)
{
