#ifndef __AP_HAL_LINUX_RCINPUT_VRLXBRAIN_H__
#define __AP_HAL_LINUX_RCINPUT_VRLXBRAIN_H__
...
enum state_t{
				RCIN_VRLXBRAIN_INITIAL_STATE = -1,
				RCIN_VRLXBRAIN_ZERO_STATE = 0,
				RCIN_VRLXBRAIN_ONE_STATE = 1
};
...
class Memory_table {
// Allow LinuxRCInput_VRLXBrain access to private members of Memory_table
friend class Linux::LinuxRCInput_VRLXBrain;
...
class Linux::LinuxRCInput_VRLXBrain : public Linux::LinuxRCInput
{ 
public:
    void init(void*);
    void _timer_tick(void);
    LinuxRCInput_VRLXBrain();
    ~LinuxRCInput_VRLXBrain();
...
#endif // __AP_HAL_LINUX_RCINPUT_VRLXBRAIN_H__
